...
public class SwerveSubsystem extends SubsystemBase {
    ...
    public Command driveCommand(DoubleSupplier translationX, DoubleSupplier translationY, DoubleSupplier headingX,
        ...
        return run(() -> {
            double xInput = Math.pow(translationX.getAsDouble(), 3); // Smooth out
    ...
    public Command driveCommand(DoubleSupplier translationX, DoubleSupplier translationY,
        ...
        return run(() -> {
            ...
            var y = Math.pow(translationY.getAsDouble(), 3) * m_swerveDrive.getMaximumVelocity();
            // if (driveSlow) {
            // x = Math.pow(translationX.getAsDouble(), 3) *
            // m_swerveDrive.getMaximumVelocity() * .5;
            // y = Math.pow(translationY.getAsDouble(), 3) *
            // m_swerveDrive.getMaximumVelocity() * .5;
            // }
